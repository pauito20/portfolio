...
export const en = {
  ...
  hero: {
    ...
    ctaCv: "Download CV",
    graphHint: "Explore the graph: every node is a stop on the tour",
  },
  about: {
    title: "About me",
  ...
  expertise: {
    title: "Expertise",
    subtitle: "The bridge between enterprise ERP and applied AI",
    education: "Education",
    certifications: "Certifications",
  },
  projects: {
    title: "Projects",
    subtitle: "Tools and research work, from code to production",
  ...
  footer: {
    ...
    builtWith: "Built with React, Three.js, and too much coffee.",
  },
  a11y: {
    graphNav: "Explore the knowledge graph",
    localeToggle: "Switch language",
    motionToggle: "Reduce motion",
    graphDecorative:
      "Decorative 3D visualization of connected ERP and AI modules",
  },
} satisfies Dict;
