...
export const es = {
  ...
  hero: {
    ...
    ctaContact: "Hablemos",
    ctaCv: "Descargar CV",
    graphHint: "Explora el grafo: cada nodo es una parada del recorrido",
  },
  about: {
    title: "Sobre mí",
  ...
  expertise: {
    title: "Especialidad",
    subtitle: "El puente entre el ERP empresarial y la IA aplicada",
    education: "Formación",
    certifications: "Certificaciones",
  },
  projects: {
    title: "Proyectos",
    subtitle: "Herramientas y trabajo de investigación, de código a producción",
  ...
  footer: {
    ...
    builtWith: "Construido con React, Three.js y demasiado café.",
  },
  a11y: {
    graphNav: "Explorar el grafo de conocimiento",
    localeToggle: "Cambiar idioma",
    motionToggle: "Reducir animaciones",
    graphDecorative:
      "Visualización 3D decorativa de módulos ERP e IA conectados",
  },
};
